...
export const CardList = ({ onDelete }) => {
  ...
  if (isDeleted) {
    return null; // Mengembalikan null jika card sudah dihapus
  }
    ...
    >
      ...
      <div className="mt-4 flex gap-4 sm:gap-6 w-full justify-between">
        <div className="flex space-x-1">
          <h2 className="text-sm font-medium text-gray-600">08.00</h2>
          <h2> - </h2>
          <h2 className="text-sm font-medium text-gray-600">08.30</h2>
        </div>
